...
Applicable GOF tests for the fitted model (RET.fit) alongside other yardsticks of model evaluation were further obtained using appropriate `gofcat` functions. A brief overview of what each function does is given, followed by an application to the model under consideration.
